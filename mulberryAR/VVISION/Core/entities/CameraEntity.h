...
public:
     ...
     */
    CCameraEntity(const vec3f& position, const vec3f& target, float32 fov, const vec3f& up = vec3f(0, 0.f, 1.f), float32 zNear = 1.0f, float32 zFar = 100.0f, float32 aspect = 320.0f/568.0f);
