...
namespace vvision
{
    class CTextureCubeMap
    {
        ...
        void ActivateAndRefresh(GLenum target, void * data, GLsizei width, GLsizei height, GLint xoffset = 0, GLint yoffset = 0,GLint level = 0, GLenum host_format = GL_RGBA, GLenum host_type = GL_UNSIGNED_BYTE);
